...
def preload_data(idx):
    ...
    all_answers = wrong + [correct]  # * bcz wrong has 3 answers and it is a list so we need to make correct also a list for concatenation to work
...
def frame2():
    #score widget
    score = QLabel(str(parameters["score"][-1]))  # * QLabel only takes str so we need to convert it
...
def frame3():
    ...
    message2 = QLabel("Congratulations")
    ...
    #logo widget
    pixmap = QPixmap('C:\VScode\JavaScript\images\Programmer2.png')
    logo = QLabel()
