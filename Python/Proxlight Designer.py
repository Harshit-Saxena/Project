...
window.iconbitmap("C:\VScode\JavaScript\Python\images\Icon.ico")
...
background_img = PhotoImage(file = f"C:\VScode\JavaScript\Python\images\ckground.png")
...
path_entry_img = PhotoImage(file = f"C:\VScode\JavaScript\Python\images\img_textBox0.png")
...
URL_entry_img = PhotoImage(file = f"C:\VScode\JavaScript\Python\images\img_textBox1.png")
...
token_entry_img = PhotoImage(file = f"C:\VScode\JavaScript\Python\images\img_textBox2.png")
...
img0 = PhotoImage(file = f"C:\VScode\JavaScript\Python\images\img0.png")
